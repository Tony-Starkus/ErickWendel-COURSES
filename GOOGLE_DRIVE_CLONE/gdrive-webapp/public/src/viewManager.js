export default class ViewManager {
  constructor() {
    ...
    this.formatter = new Intl.DateTimeFormat('pt', { month: 'long', day: 'numeric', year: 'numeric', hour: '2-digit', minute: '2-digit' })
  }

  init() {
    this.configureFileBtnClick()
  }
  ...
  configureModal() {
    this.modalInstance = M.Modal.init(this.progressModal, {
      opacity: 0,
      dismissable: false,
      // Isso aqui libera para clicar na tela mesmo com o modal aberto
      onOpenEnd() {
  ...
  makeIcon(file) {
    ...
    const colors = { image: 'yellow600', 'movie': 'red600', file: '' }
