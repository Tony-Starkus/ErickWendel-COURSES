...
const origialHttp = jest.createMockFromModule('http');
...
describe('HTTP Interceptor Agent', () => {
  ...
  test('should not change header', () => {
    ...
    const serverInstance = new origialHttp.Server()
  ...
  test('should activate header interceptor', () => {
    ...
    expect(response.setHeader).toHaveBeenCalledWith('X-Instrumented-By', 'Thalisson')
  })
})
